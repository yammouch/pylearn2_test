...
class XOR(DenseDesignMatrix):
    ...
    def __init__(self):
        ...
        X = [[randint(0, 1), randint(0, 1)] for _ in range(10000)]
        y = []
...
print hidden_layer.b.get_value()
print hidden_layer.get_biases()
print hidden_layer.get_weights_format()
...
#f = theano.function([X], ann.fprop(X))
#
#inputs = np.array([[0, 0]])
#print f(inputs)
#inputs = np.array([[0, 1]])
